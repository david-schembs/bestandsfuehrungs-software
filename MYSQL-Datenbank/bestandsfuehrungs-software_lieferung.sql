...
CREATE TABLE `lieferung` (
  ...
  PRIMARY KEY (`produkt`,`lieferant`),
  KEY `lieferant` (`lieferant`),
  CONSTRAINT `lieferung_ibfk_1` FOREIGN KEY (`produkt`) REFERENCES `produkt` (`ID`),
  CONSTRAINT `lieferung_ibfk_2` FOREIGN KEY (`lieferant`) REFERENCES `lieferant` (`ID`)
...
INSERT INTO `lieferung` VALUES (5,2),(7,3),(11,6),(12,11),(13,11),(4,14),(15,16),(13,19),(1,20),(9,21),(3,23),(5,24),(10,26),(2,27),(6,27),(8,28),(6,32),(14,35);
